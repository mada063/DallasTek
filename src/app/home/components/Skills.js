...
const Skills = () => {
  const skills = [
    ...
    { src: '/images/CSS.png', alt: 'CSS Ikon', name: 'CSS' },
    { src: '/images/HTML.png', alt: 'HTML Ikon', name: 'HTML' },
    { src: '/images/Javascript.png', alt: 'JS Ikon', name: 'Javascript' },
    { src: '/images/React.png', alt: 'React Ikon', name: 'React' },
    { src: '/images/Vue.png', alt: 'Vue Ikon', name: 'Vue' },
